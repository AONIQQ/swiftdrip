...
import { RAPID_TESTS, BOOKING_URL } from "@/lib/constants";
...
export default function RapidTestingPage() {
      ...
      <section className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            {RAPID_TESTS.map((test, i) => {
              const Icon = TEST_ICONS[test.name] ?? Zap;
              return (
                <FadeInSection key={test.name} delay={i * 0.1}>
